...
<div class="content" id="content">  
    ...
    <div class="row" style="position:relative; height:0px;">
    ...
    <img class="arrow arrow-right col-xs-2 col-sm-1 col-md-1 col-lg-1" src="<?php echo get_template_directory_uri() . '/images/arrow-right.png'?>" id="arrow-right">
         ...
         <div class="hidden-md hidden-lg hidden-xs">
            ...
            <div class="slider-noticias hidden-xs hidden-md hidden-lg col-xs-12" data-slick='{"slidesToShow": 1, "rows":6, "slidesToScroll": 1}'>
    ...
    <div class="row" style="position:relative; height:0px;">
    <img class="arrow arrow-left col-xs-2 col-sm-2 col-md-1 col-lg-1" src="<?php echo get_template_directory_uri() . '/images/arrow-left.png'?>" id="arrow-left2">
    <div class="col-xs-8 col-sm-8 col-md-11 col-lg-11"></div>
    <img class="arrow arrow-right col-xs-2 col-sm-2 col-md-1 col-lg-1" src="<?php echo get_template_directory_uri() . '/images/arrow-right.png'?>" id="arrow-right2">
    </div>
