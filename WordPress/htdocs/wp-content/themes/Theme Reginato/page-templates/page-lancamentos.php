...
<div class="content" id="content">  
    ...
    <section id="noticias" class="noticias row col-md-8 col-sm-7 col-lg-9 col-xs-12">
        ...
        <div class="hidden-md hidden-lg hidden-xs">
            ...
            <div class="slider-noticias col-sm-12 hidden-md hidden-lg hidden-xs" data-slick='{"slidesToShow": 1, "rows":6, "slidesToScroll": 1}'>
    ...
    <img class="arrow arrow-left col-xs-2 col-sm-2 col-md-1 col-lg-1" src="<?php echo get_template_directory_uri() . '/images/arrow-left.png'?>" id="arrow-left">
    <div class="col-xs-8 col-sm-8 col-md-10 col-lg-10"></div>
    <img class="arrow arrow-right col-xs-2 col-sm-2 col-md-1 col-lg-1" src="<?php echo get_template_directory_uri() . '/images/arrow-right.png'?>" id="arrow-right">
    </div>
    </div>
