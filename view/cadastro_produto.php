                                ...
                                for (var i = 0, len = data.length; i < len; i++) {
                                    if(data[i].ativo){
                                         ...
                                         table.row.add( [
                                            ...
                                            data[i].fabrica.nome,
                                            "<b>active</b>",
                                            '<a  objectId='+data[i].id_produto+' class="btn btn-info edit"  ><i class="icon-edit "></i></a> <a  objectId='+data[i].id_produto+' class="btn btn-danger delete" ><i class="icon-trash "></i> </a>',"",""
                                        ] ).draw( false );
